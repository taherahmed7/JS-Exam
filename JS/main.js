...
$('#openbtn').click(function () {
    $('#navbar1').animate({ width: '250px', height: '100%' }, 1000)
})
...
async function getMainIngredient(mealName) {
    $(".loading-container").fadeIn(100)
    let meal = await fetch(`https://www.themealdb.com/api/json/v1/1/random.php=${mealName}`)
...
// HttpRequest.open('get', 'https://www.themealdb.com/api/json/v1/1/filter.php?a=Canadian')
// HttpRequest.send();
